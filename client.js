  ...
  factory: (require) => {
    ...
    if (
      ...
      tag.textContent = [
        ...
        '[data-dsh-balance-widget] { box-sizing: border-box; width: 264px; background: var(--dsw-alias-bg-elevated, #ffffff); border: 1px solid var(--dsw-alias-border-l2, #e5e7eb); border-radius: 12px; box-shadow: 0 8px 28px rgba(0, 0, 0, 0.16); color: var(--dsw-alias-label-primary, #111827); font-family: var(--dsw-font-family, system-ui, sans-serif); font-size: 13px; line-height: 1.45; user-select: none; overflow: hidden; }',
        ...
        '[data-dsh-balance-widget-dot][data-status="error"] { background: #ef4444; }',
        ...
        '[data-dsh-balance-widget-link] { color: var(--dsw-alias-brand-primary, #3964fe); font-size: 12px; text-decoration: none; cursor: pointer; white-space: nowrap; }',
        ...
        '[data-dsh-balance-widget-error] { color: #ef4444; font-size: 12px; white-space: pre-wrap; word-break: break-all; }',
        '[data-dsh-balance-widget-status] { display: flex; align-items: center; gap: 6px; padding: 2px 0; }',
        '[data-dsh-balance-widget-pill] { position: fixed; right: 20px; bottom: 20px; z-index: 9999; border: 1px solid var(--dsw-alias-border-l2, #e5e7eb); background: var(--dsw-alias-bg-elevated, #ffffff); color: var(--dsw-alias-label-primary, #111827); border-radius: 18px; padding: 6px 12px; font-size: 12px; cursor: grab; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.14); font-family: var(--dsw-font-family, system-ui, sans-serif); touch-action: none; }',
        '[data-dsh-balance-widget-pill]:hover { background: var(--dsw-alias-brand-primary, #3964fe); color: #fff; }',
